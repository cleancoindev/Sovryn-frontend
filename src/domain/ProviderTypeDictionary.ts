...
import nifty_logo, { ReactComponent as NiftyLogo } from '../assets/images/logo_big___nifty.svg';
...
export class ProviderTypeDictionary {
  public static providerTypes: Map<ProviderType, ProviderTypeDetails> = new Map<ProviderType, ProviderTypeDetails>([
    ...
    [ProviderType.Nifty, new ProviderTypeDetails("Nifty", nifty_logo, NiftyLogo, NiftyLogo)],
    [ProviderType.None, new ProviderTypeDetails("X", null, null, null)]
  ]);
}
