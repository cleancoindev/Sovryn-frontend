  ...
  public render() {
    return (
      <div className="trade-page">
	    ...
	    For your safety, please ensure the URL in your browser starts with: https://sovryn.app.trade/.
	    Sovryn is a non-custodial platform for tokenized lending and margin trading.
	    &quot;Non-custodial&quot; means YOU are responsible for the security of your digital assets.
          </InfoBlock>
