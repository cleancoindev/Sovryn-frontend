...
export class TradeTokenCardMobile extends Component<ITradeTokenCardMobileProps, ITradeTokenCardMobileState> {
  ...
  private getTradeTokenGridRowSelectionKeyRaw(
    props: ITradeTokenCardMobileProps,
    leverage: number = this.state.leverage
  ) {
  ...
  private onPositionTypeChange = (value: string) => {
    this.setState({
      isLong: value == PositionType.LONG
    });
    this.props.changeActiveBtn(value == PositionType.LONG ? "long" : "short");
  };
    ...
    return (
      <div className="trade-token-card-mobile">
        <div className="trade-token-card-mobile__header">
          ...
          <PositionTypeSelector onChange={this.onPositionTypeChange} value={this.state.isLong ? PositionType.LONG : PositionType.SHORT} />
        </div>
        <div className="trade-token-card-mobile__body">
          ...
          <div className="trade-token-card-mobile__body-row">
            ...
            <div
              ...
              className="trade-token-card-mobile__profit"
            >
  ...
  private renderActions = (isBuyOnly: boolean) => {
    return (
      <div className="trade-token-card-mobile__action">
        <button
          className="trade-token-card-mobile____buy-button"
